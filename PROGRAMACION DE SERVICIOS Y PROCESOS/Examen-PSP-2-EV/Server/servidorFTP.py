...
def ssh_Connection():
    ...
    sftp_client.get("public.pem", "public.pem")

    sftp_client.close()
    ssh.close()

def decrypt(filename):
    archivo_encriptado = open(filename, "rb")
    ...
    file = open("DanielTomasMartinez.txt", "wb")
...
def smtp_Send_Mail():
    ...
    file = open("DanielTomasMartinez.txt", "rb")
...
def ftp_Connection():
    ...
    USERNAME = "admin"
    PASSWORD = "preguntadalprofe"
    
    ftp_server = ftplib.FTP(HOSTNAME, USERNAME, PASSWORD)
    ftp_server.encoding = "utf-8"

    filename = "DanielTomasMartinez.txt"
    with open(filename, "rb") as file:
        # Command for Uploading the file "STOR filename"
        ftp_server.cwd("/home/admin/ftp")
