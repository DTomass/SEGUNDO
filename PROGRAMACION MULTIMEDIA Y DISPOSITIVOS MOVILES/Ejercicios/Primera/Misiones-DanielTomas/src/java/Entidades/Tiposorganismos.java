...
public class Tiposorganismos implements Serializable {
    ...
    private List<Tiposentidades> tiposentidadesList;
    ...
    @XmlTransient
    public List<Tiposentidades> getTiposentidadesList() {
        return tiposentidadesList;
    }

    public void setTiposentidadesList(List<Tiposentidades> tiposentidadesList) {
        this.tiposentidadesList = tiposentidadesList;
    }
    ...
    public String toString() {
        return "Entidades.Tiposorganismos[ codTipo=" + codTipo + " ]";
    }
