...
@Named("sedesController")
@SessionScoped
public class SedesController implements Serializable {

    private Sedes current;
    private DataModel items = null;
    @EJB
    private Facades.SedesFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Sedes) getItems().getRowData();
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SedesDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectSedes() {
        return JsfUtil.getSelectSedes(ejbFacade.findAll(), true);
    }

    public Sedes getSedes(java.lang.String id) {
        return ejbFacade.find(id);
    }

    @FacesConverter(forClass = Sedes.class)
    public static class SedesControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getSedes(getKey(value));
        }
