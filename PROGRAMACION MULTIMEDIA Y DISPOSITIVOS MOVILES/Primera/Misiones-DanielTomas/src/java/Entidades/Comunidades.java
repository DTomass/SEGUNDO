...
public class Comunidades implements Serializable {
    ...
    public Comunidades(Short codComunidad) {
        this.codComunidad = codComunidad;
    }

    public Short getCodComunidad() {
        return codComunidad;
    }

    public void setCodComunidad(Short codComunidad) {
        this.codComunidad = codComunidad;
    }
    ...
    public String toString() {
        return "Entidades.Comunidades[ codComunidad=" + codComunidad + " ]";
    }
