...
public class Subsectorespropios implements Serializable {
    ...
    public Sectorespropios getCodSector() {
        return codSector;
    }

    public void setCodSector(Sectorespropios codSector) {
    ...
    public String toString() {
        return "Entidades.Subsectorespropios[ codSubsector=" + codSubsector + " ]";
    }
