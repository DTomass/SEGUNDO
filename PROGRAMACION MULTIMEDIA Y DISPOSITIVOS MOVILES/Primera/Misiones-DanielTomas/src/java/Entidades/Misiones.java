...
public class Misiones implements Serializable {
    ...
    @OneToMany(mappedBy = "codMision")
    private List<Misioneros> misionerosList;

    public Misiones() {
    }

    public Misiones(Short codMision) {
        this.codMision = codMision;
    }

    public Short getCodMision() {
        return codMision;
    }

    public void setCodMision(Short codMision) {
        this.codMision = codMision;
    }
    ...
    @XmlTransient
    public List<Misioneros> getMisionerosList() {
        return misionerosList;
    }

    public void setMisionerosList(List<Misioneros> misionerosList) {
        this.misionerosList = misionerosList;
    }
    ...
    public String toString() {
        return "Entidades.Misiones[ codMision=" + codMision + " ]";
    }
